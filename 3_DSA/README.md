...
Focus topics:
- Arrays, strings, hashing, and custom comparators
- Graph traversal, shortest paths, and cycle checks
- Dynamic programming staples like LIS and knapsack
- Stacks, queues, heaps, and binary search tricks

Practice set:
- LRU cache, LIS, Dijkstra, trie autocomplete, palindrome substrings